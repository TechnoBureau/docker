...
func main() {
	...
	// Set the desired default time zone
	desiredTimeZone := "Asia/Kolkata" // Replace with your desired time zone
	err := models.SetDefaultTimeZone(desiredTimeZone)
	if err != nil {
		log.Errorln("Error loading location:", err)
		return
	}
